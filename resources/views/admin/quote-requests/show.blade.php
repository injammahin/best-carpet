        ...
        <div class="space-y-6">
            ...
            <div class="clean-card bg-white p-6">
                ...
                <div class="mt-6 grid gap-5 md:grid-cols-2">
                    ...
                    <div class="rounded-[14px] bg-mega-soft p-4">
                        <p class="text-xs uppercase tracking-[0.16em] text-mega-muted">Local Store</p>
            ...
            <div class="clean-card bg-white p-6">
                ...
                <div class="mt-6 grid gap-5 md:grid-cols-2">
                    ...
                    <div class="rounded-[14px] bg-mega-soft p-4 md:col-span-2">
                        ...
                        <p class="mt-2 leading-7 text-mega-black">
                            {{ $quoteRequest->comments ?: 'No additional comments provided.' }}
                        </p>
                    </div>
                </div>
            </div>
                ...
                <form method="POST" action="{{ route('admin.quote-requests.status', $quoteRequest) }}" class="mt-6">
                    ...
                    <select name="status"
                        ...
                        <option class="text-black" value="contacted" @selected($quoteRequest->status === 'contacted')>
                            Contacted</option>
                        <option class="text-black" value="booked" @selected($quoteRequest->status === 'booked')>Booked
                        </option>
                        <option class="text-black" value="completed" @selected($quoteRequest->status === 'completed')>
                            Completed</option>
                        <option class="text-black" value="archived" @selected($quoteRequest->status === 'archived')>Archived
                        </option>
                    </select>
